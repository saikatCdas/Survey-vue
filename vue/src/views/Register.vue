        ...
        <form class="mt-8 space-y-6" @submit="register">
          ...
          <div class="-space-y-px rounded-md shadow-sm">
            <div>
              ...
              <input v-model="user.name" id="fullname" name="name" type="text" autocomplete="name" required="" class="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Enter your full name" />
            </div>
            <div>
...
//               errorMsg.value = `The password must contain at least one uppercase, one lowercase letter and one symbol`
//             }
//             else if(error.password.length === 1){
//               errorMsg.value = error.password[0]
//             }
//             else{
